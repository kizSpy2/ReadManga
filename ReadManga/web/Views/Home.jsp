<%-- 
    Document   : Home
    Created on : Oct 21, 2022, 7:56:52 AM
    Author     : ducan
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light shadow py-2 py-sm-0">
            ...
            <div class="profile float-right">
                ...
                <div class="account">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="http://localhost:8080/ReadManga/Login">Login</a>
                        <a class="dropdown-item" href="http://localhost:8080/ReadManga/Registrantion">Create a account</a>
                    </div>
                </div>
            </div>
